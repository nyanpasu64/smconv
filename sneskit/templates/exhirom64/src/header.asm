...
MODE_25			=25H	; mode 25, 2.68 mhz (ExHiROM)
...
ROMNAME:
;-------------------------------;-----------------------------------------;
.byte   "SNES TEMPLATE"		; C0 - game title
;-------------------------------;-----------------------------------------;
...
.endif
;-------------------------------;-----------------------------------------;
.byte	MODE_25|FASTROM		; D5 - map mode
.byte	CART_ROM		; D6 - cartridge type (ROM only)
.byte	0Ch			; D7 - ROM size (set with sneschk)
