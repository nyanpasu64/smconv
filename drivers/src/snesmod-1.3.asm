...
; (c) 2014 Additional code added by Augustus Blackheart
;
;
;========================================================
...
GAIN_RATE = 1Ch ; 1eh = 4ms; 1ceh = 8ms
...
;-----------------------------------------------------------------------
	...
	.byte	LBYTE(Command_SetSR)			; Zxy MidiMacro
;-----------------------------------------------------------------------
CMD_JUMPTABLE_H:
;-----------------------------------------------------------------------
	...
	.byte	HBYTE(Command_SetSR)			; Zxy MidiMacro
...
;=======================================================================
	...
	mov	a, !CmdExTab_L+y		;
	mov	!cmdex_jmp+1, a			;
	;mov	a, !CmdExTab_H+y		; (all commands are at
	;mov	!cmdex_jmp+2, a			;  0exxh)
