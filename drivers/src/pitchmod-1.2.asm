...
PatternMemory		=0340h	; 16*8 bytes
StreamAddress		=03c0h	; 4 bytes       (streaming buffer address)
...
_calcvol_skip_gvol:				;
	...
	mov	a, #%10011100			; (8ms)
_gain_not_zero:					;
	cmp	a, #126				; map value 127 to fast linear increase
...
;=======================================================================
	...
	mov	!cmdex_jmp+1, a			;
	mov	a, !CmdExTab_H+y		;
	;mov	a, HBYTE(SCommand_EPN)		; all commands are at $0exx
	mov	!cmdex_jmp+2, a			;
